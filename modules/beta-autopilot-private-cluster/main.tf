...
locals {
  ...
  cluster_endpoint_for_nodes = (var.enable_private_nodes && length(google_container_cluster.primary.private_cluster_config) > 0 && var.master_ipv4_cidr_block==null) ? "${local.cluster_endpoint}/32" : var.master_ipv4_cidr_block
